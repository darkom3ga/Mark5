...
class GStreamerVideo:
    def __init__(self, pipeline_str):
        ...
        self.frame_queue = []
        self.max_queue_size = 50  # Increase queue size to buffer a few frames for smoother playback
    ...
    def start(self):
        ...
        self.video_sink.set_property('max-buffers', 60)  # Larger buffer size to reduce lag
    ...
    def on_new_sample(self, sink):
        print(f"Received sample for camera")
...
pipeline_template = """
    udpsrc port={} buffer-size=2097152 ! 
...
def generate_frames(camera_instance):
    print(f"Generating frames for {camera_instance}")
